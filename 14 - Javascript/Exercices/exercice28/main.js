...
// tableau vides pour stocker les vehicules
const vehicules = new Array(); // [] 

// fonction pour trouver si un vehicule est present dans le parking
function findCar(){
...
// afficher un message dans le dom pendant un delai choisie
...
setTimeout(() => {
    // cacher cet element apres delay miliseconde
    domElement.style.display ="none";
},delay);
}

// ajouter un vehicule au parking
function addtoPark(){
...
// clique sur le bouton prendre un ticket
...
vehicules.push(new Vehicule('AA-123-AA',new Date("2024-01-31T15:00:00")))
vehicules.push(new Vehicule('BB-123-AA',new Date("2024-01-31T15:15:00")))
vehicules.push(new Vehicule('CC-123-AA',new Date("2024-01-31T15:28:00")))
