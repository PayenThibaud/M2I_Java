...
VALUES
	('Domain-Driven Design: Tackling Complexity in the Heart of Software', 'Eric Evans','Addison-Wesley', '2003-08-20', '0321125215', '978-0321125217');  

-- Q8
DELETE FROM
	livre
WHERE
	titre = 'Lève-toi et Vends !';
...
ALTER TABLE
	livre
ALTER COLUMN date_publication TYPE DATE;
