...
<jsp:useBean id="dog" type="entity.Chien" scope="request" />
        ...
        <div class="col-8 offset-2 p-3 rounded text-bg-dark">
            ...
            <form action="<%= mode.equals("add") ? "add" : "" %>" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" id="name" class="form-control" value="<%= dog.getNomChien() %>" <% if (mode.equals("add")) { %> required <% } else { %> readonly <% } %>>
                </div>
                <div class="mb-3">
                    <label for="breed" class="form-label">Breed:</label>
                    <input type="text" name="breed" id="breed" class="form-control" value="<%= dog.getRace() %>" <% if (mode.equals("add")) { %> required <% } else { %> readonly <% } %>>
                </div>
                <div class="mb-3">
                    <label for="birthDate" class="form-label">Birth date:</label>
                    <input type="date" name="birthDate" id="birthDate" class="form-control" value="<%= dog.getDateNaissance() %>" <% if (mode.equals("add")) { %> required <% } else { %> readonly <% } %>>
                </div>
